...
public class BootstrapPagerAdapter extends FragmentPagerAdapter {
    ...
    public CharSequence getPageTitle(final int position) {
        switch (position) {
            case 0:
                return resources.getString(R.string.title_campaign);
            case 1:
                return resources.getString(R.string.title_activity_hit);
            case 2:
                return resources.getString(R.string.title_message);
            default:
                return null;
        }
    }
